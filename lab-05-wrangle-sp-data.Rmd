...
5.  What function from the tidyverse do we use the add a new variable to a data frame while keeping the existing variables? ***(mutate function)***
...
***The cloest Denny's and La Quinta in Alaska are about 2 miles away, and the farthest is about 6 miles. The mean distance is 4.41 miles.***
...
***The average distance between a Denny's and La Quinta in North Carolina is 65.4432 miles.***
...
***For Texas, the average distance between a Denny's and La Quinta is 5.7918 miles.***
...
***In New York, the average distance between Denny's and La Quinta is 33.5745 miles.***

12. Among the states you examined, where is Mitch Hedberg's joke most likely to hold true?
    Explain your reasoning.

***It is most true in Texas. In Texas there is a very small mean distance between Denny's and La Quinta's, as well as a lot of both Denny's and La Quinta's. In Alaska, the mean distance is also very small, but there are also less Denny's and La Quinta's.***
